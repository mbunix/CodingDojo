export function enterFrameDetails(frameNumber: number, tryNumber: number, remainingPins?: number): Promise<number> {
  return new Promise((resolve, reject) => {
    ...
    if (remainingPins === undefined) {
      ...
      stdin.addListener("data", (input: Buffer) => {
...
export function generateRandomScore(frameNumber: number, tryNumber: number, remainingPins?: number): number {
